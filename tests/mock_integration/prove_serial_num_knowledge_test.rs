...
pub fn create_partial_swap_note(
    ...
    let note_code = include_str!("../../src/test/serial_num_knowledge.masm");
    ...
    // let padded_secret = pad_inputs(&secret);
    // let hashed_secret: Word = Hasher::hash_elements(&padded_secret).into();
...
#[test]
fn test_prove_hash_preimage_knowlegde() {
    // ASSETS
    // Offered Asset
    ...
    // SUPPLY SERIAL NUM AS NOTE ARGS
    let note_args = [[serial_num[0], serial_num[1], serial_num[2], serial_num[3]]];
